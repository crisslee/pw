...
public class XiaomiHomeBadger extends Badger
{
                             ...
                             int count)
    {
        try
        {
            if(notification!=null)
            {
                ...
                //小米这里只要这个notificationId 对应的count，而不是所有notification count
    ...
    {
        return Arrays.asList("com.miui.miuilite", "com.miui.home", "com.miui.miuihome", "com.miui.miuihome2",
                "com.miui.mihome", "com.miui.mihome2");
    }
}

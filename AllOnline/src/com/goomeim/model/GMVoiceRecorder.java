...
public class GMVoiceRecorder {
    ...
    public GMVoiceRecorder(Handler handler) {
    ...
    public String startRecording(Context appContext) {
        ...
        try {
            ...
            // file = File.createTempFile(PREFIX + user_id, EXTENSION,
            // User.getVoicePath());
            voiceFileName = getVoiceFileName(GMClient.getInstance().getCurrentUserId());
    ...
    public int stopRecoding() {
        if (recorder != null) {
            ...
            if (file == null || !file.exists() || !file.isFile()) {
                return GMError.ERROR_FILE_INVALID;
            }
            if (file.length() == 0) {
                file.delete();
                return GMError.ERROR_FILE_INVALID;

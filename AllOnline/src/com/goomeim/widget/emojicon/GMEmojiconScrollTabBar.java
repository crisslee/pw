...
public class GMEmojiconScrollTabBar extends RelativeLayout
{
    ...
    private GMScrollTabBarItemClickListener itemClickListener;

    private int tabWidth = 60;

    public GMEmojiconScrollTabBar(Context context)
    {
        this(context, null);
    }

    public GMEmojiconScrollTabBar(Context context, AttributeSet attrs, int defStyle)
    {
        this(context, attrs);
    }

    public GMEmojiconScrollTabBar(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    public void addTab(int icon)
    {
        ...
        LinearLayout.LayoutParams imgParams =
            new LinearLayout.LayoutParams(DensityUtil.dip2px(context, tabWidth), LayoutParams.MATCH_PARENT);
    ...
    public void setTabBarItemClickListener(GMScrollTabBarItemClickListener itemClickListener)
    {
        this.itemClickListener = itemClickListener;
    }

    public interface GMScrollTabBarItemClickListener
    {

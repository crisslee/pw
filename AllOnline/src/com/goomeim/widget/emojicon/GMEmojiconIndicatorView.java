...
@SuppressLint("NewApi")
public class GMEmojiconIndicatorView extends LinearLayout {
    ...
    public GMEmojiconIndicatorView(Context context, AttributeSet attrs, int defStyle)
    {
        this(context, null);
    }

    public GMEmojiconIndicatorView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context, attrs);
    }

    public GMEmojiconIndicatorView(Context context)
    {
        this(context, null);
    }
    ...
    private void init(Context context, AttributeSet attrs)
    {
        ...
        unselectedBitmap =
            BitmapFactory.decodeResource(context.getResources(), R.drawable.ease_dot_emojicon_unselected);

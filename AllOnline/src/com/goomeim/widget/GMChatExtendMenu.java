...
import net.goome.im.util.DensityUtil;
...
public class GMChatExtendMenu extends GridView {
    ...
    public GMChatExtendMenu(Context context, AttributeSet attrs, int defStyle)
    {
        this(context, attrs);
    }

    public GMChatExtendMenu(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     */
    public void registerMenuItem(String name, int drawableRes, int itemId, GMChatExtendMenuItemClickListener listener)
    {
     ...
     * @param listener    on click event of item
     */
    public void registerMenuItem(int nameRes, int drawableRes, int itemId, GMChatExtendMenuItemClickListener listener)
    {
    ...
    private class ItemAdapter extends ArrayAdapter<ChatMenuItemModel>
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent)
        {
            ...
            if (getItem(position).name != null && getItem(position).name.equals(
                getContext().getString(R.string.redpacket)))
            {
                //红包是否展示
                if (AllOnlineApp.getAppConfig().getGroup_redpacket_onoff() == 0)
                {
    ...
    public interface GMChatExtendMenuItemClickListener
    {
    ...
    class ChatMenuItemModel
    {
        ...
        int image;
        int id;
        GMChatExtendMenuItemClickListener clickListener;
    }

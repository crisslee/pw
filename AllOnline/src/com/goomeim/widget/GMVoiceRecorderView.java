...
import com.goomeim.model.GMVoiceRecorder;
...
public class GMVoiceRecorderView extends RelativeLayout
{
    ...
    protected GMVoiceRecorder voiceRecorder;
    ...
    protected Handler micImageHandler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            // change image
            int index = msg != null ? msg.what : 0;
            if (micImages != null && index >= 0 && index < micImages.length) {
    ...
    public GMVoiceRecorderView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context);
    }

    public GMVoiceRecorderView(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    private void init(Context context)
    {
        ...
        voiceRecorder = new GMVoiceRecorder(micImageHandler);
    ...
    public boolean onPressToSpeakBtnTouch(View v, MotionEvent event, EaseVoiceRecorderCallback recorderCallback)
    {
        switch (event.getAction())
        {
            case MotionEvent.ACTION_DOWN:
                try
                {
                    if (GMChatRowVoicePlayClickListener.isPlaying)
                    {
            ...
            case MotionEvent.ACTION_UP:
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        if (length == GMError.ERROR_FILE_INVALID)
                        {

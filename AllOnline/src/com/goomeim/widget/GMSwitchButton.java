...
public class GMSwitchButton extends FrameLayout
{

    private ImageView openImage;
    private ImageView closeImage;

    public GMSwitchButton(Context context, AttributeSet attrs, int defStyle)
    {
        this(context, attrs);
    }

    public GMSwitchButton(Context context)
    {
        this(context, null);
    }

    public GMSwitchButton(Context context, AttributeSet attrs)
    {
        super(context, attrs);

...
/**
 * Created by lzan13 on 2015/4/30. customized ImageView，Rounded Rectangle and
 * border is implemented, and change color when you press
 */
public class GMImageView extends ImageView
{
    ...
    public GMImageView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context, attrs);
    }

    public GMImageView(Context context, AttributeSet attrs, int defStyleAttr)
    {

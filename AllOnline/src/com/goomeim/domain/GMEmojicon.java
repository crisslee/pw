...
public class GMEmojicon
{
	 ...
	 *            text of emoji icon
	 */
	public GMEmojicon(int icon, String emojiText)
	{
		this.icon = icon;
	 ...
	 *            - normal or big
	 */
	public GMEmojicon(int icon, String emojiText, Type type)
	{
		this.icon = icon;
		this.emojiText = emojiText;
		this.type = type;
	...
	{
		/**
		 * normal icon, can be input one or more in edit rootView
		 */
		NORMAL,
		/**

...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator
{
	...
	protected void onDraw(Canvas canvas)
	{
		...
		dividerPaint.setColor(Color.parseColor("#cbccd0"));
		for (int i = 0; i < childCount - 1; i++)
		{
			View tab = mTabLayout.getChildAt(i);
			canvas.drawLine(tab.getRight(), CommunityUtil.convertDIP2PX(mContext, 20), tab.getRight(),
					height - CommunityUtil.convertDIP2PX(mContext, 20), dividerPaint);
		}
	}

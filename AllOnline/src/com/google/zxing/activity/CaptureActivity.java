...
public class CaptureActivity extends BaseActivity implements Callback {
    ...
    private void initIntent() {
        ...
        if (i.hasExtra(SHOW_MANUAL)) {
            showManual = i.getBooleanExtra(SHOW_MANUAL, false);
        }
    }
    ...
    private void toInputImei() {
        Intent i = new Intent(this, InputImeiActivity.class);
        startActivityForResult(i, REQUEST_CODE_MANUAL_INPUT);
    }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (result != null) {
                    ...
                    bundle.putString(ZConstant.INTENT_EXTRA_KEY_QR_SCAN ,result.getText());
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            ...
            Intent resultIntent = new Intent();
            Bundle bundle = new Bundle();
            bundle.putString(ZConstant.INTENT_EXTRA_KEY_QR_SCAN, resultString);
        ...
        rxPermissions.requestEach(Manifest.permission.CAMERA)
            .subscribe(permission -> {
                if (permission.granted) {
                    ...
                    showSettingDlg(getString(R.string.per_cam_hint), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            PermissionUtil.goIntentSetting(CaptureActivity.this);
                        }
                    });
                } else {

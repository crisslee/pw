...
public class BaseEvent {
    ...
    public static class ConnectionReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            GMLog.i(TAG, "recv network changed");
        ...
        public boolean isNetworkChange(final Context context, final NetworkInfo activeNetInfo) {
            ...
            if (isWifi) {
                ...
                if (wi != null && lastWifiInfo != null && (
                    (lastWifiInfo.getBSSID() != null && lastWifiInfo.getBSSID().equals(wi.getBSSID()))
                        || (lastWifiInfo.getBSSID() == null && wi.getBSSID() == null))

...
public class TinkerReport {
    private static final String TAG = TinkerReport.class.getSimpleName();
    ...
    public static void onTryApplyFail(int errorCode) {
        ...
        switch (errorCode) {
            ...
            case TinkerUtil.ERROR_PATCH_ROM_SPACE:
                ...
                break;
            case TinkerUtil.ERROR_PATCH_GOOGLEPLAY_CHANNEL:
    ...
    public static void onLoadInterpretReport(int type, Throwable e) {
        ...
        switch (type) {
            case ShareConstants.TYPE_INTERPRET_GET_INSTRUCTION_SET_ERROR:
                ...
                reporter.onReport(
                    "Tinker Exception:interpret occur exception " + TinkerUtil.getExceptionCauseString(e));
                break;
    ...
    public static void onLoadException(Throwable throwable, int errorCode) {
        ...
        if (!isCheckFail) {
            reporter.onReport(
                "Tinker Exception:load tinker occur exception " + TinkerUtil.getExceptionCauseString(throwable));
        }
    }
    ...
    public static void onApplyDexOptFail(Throwable throwable) {
        ...
        if (throwable.getMessage().contains(ShareConstants.CHECK_DEX_OAT_EXIST_FAIL)) {
            ...
            reporter.onReport(
                "Tinker Exception:apply tinker occur exception " + TinkerUtil.getExceptionCauseString(throwable));
        }
    }

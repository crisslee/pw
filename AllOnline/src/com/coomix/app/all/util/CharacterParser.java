...
public class CharacterParser {
     ...
     * 获取汉字的完整拼音 （小写）
     */
    public String hanziToPinyin_All(String hanzi) {
        String pingyin;
        if ("重庆".equals(hanzi)) {
            pingyin = "chongqin";
        } else {
            pingyin = getSelling(hanzi);
            if (pingyin != null && pingyin.contains("unkown")) {
                pingyin = "#";
            }
        }
        return pingyin == null ? "" : pingyin;
    }
    ...
    public String hanziToPinyin(String hanzi) {
        String pinyin = hanziToPinyin_All(hanzi);

...
public interface ObservableScrollViewCallbacks {
     ...
     * This won't be called just after the rootView is laid out, so if you'd like to
     ...
     * @param dragging    true when the rootView is dragged and false when the rootView is scrolled in the inertia
     */

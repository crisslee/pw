...
package com.coomix.app.all.widget.observableList;
...
/**
 * ExpandableListView that its scroll position can be observed.
 */
public class ObservableListView extends ExpandableListView implements Scrollable {
        ...
        if (mCallbacks != null) {
            switch (ev.getActionMasked()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    // passed to parent (this rootView), the flags will be invalid.

package com.coomix.app.all.weizhang.adapter;
...
public class ListAdapter extends BaseAdapter {
	...
	private  List<ListModel> mDate = new ArrayList<ListModel>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//ImageView image=(ImageView)rootView.findViewById(R.id.iv_1);

...
import com.coomix.app.all.weizhang.adapter.ListAdapter;
import com.coomix.app.all.weizhang.adapter.ListModel;
...
public class ProvinceList extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionbar.initActionbar(true, "选择查询地-省份", 0, 0);

		lv_list = (ListView) findViewById(R.id.lv_1ist);
		
		List<ListModel> models = getData2();
		if(models == null){
			this.finish();
		}

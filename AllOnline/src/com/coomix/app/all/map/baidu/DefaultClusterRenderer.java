...
/**
 * The default rootView for a ClusterManager. Markers are animated in and out of
 * clusters.
 */
@SuppressLint("NewApi")
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    /**
     * ViewModifier ensures only one re-rendering of the rootView occurs at a time,
    ...
    /**
     * Transforms the current rootView (represented by
    ...
    private static Point findClosestCluster(List<Point> markers, Point point) {
        ...
        double minDistSquared = com.coomix.app.all.map.baidu.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM * com.coomix.app.all.map.baidu.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
        Point closest = null;

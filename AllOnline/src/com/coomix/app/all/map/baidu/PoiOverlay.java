...
public class PoiOverlay extends OverlayManager {
     ...
     */
    public PoiOverlay(BaiduMap baiduMap, String type) {
        super(baiduMap);

        if (type.equals("停车场")) {
            bitmap = BitmapDescriptorFactory.fromResource(R.drawable.interestpoint_park);
        } else if (type.equals("加油站")) {
            bitmap = BitmapDescriptorFactory.fromResource(R.drawable.ic_gas);
        } else if (type.equals("维修厂")) {
            bitmap = BitmapDescriptorFactory.fromResource(R.drawable.ic_car_fix);
        } else if (type.equals("银行")) {
            bitmap = BitmapDescriptorFactory.fromResource(R.drawable.interestpoint_bank);
        } else if (type.equals("厕所")) {
            bitmap = BitmapDescriptorFactory.fromResource(R.drawable.interestpoint_toilet);
        } else if (type.equals("景点")) {
            bitmap = BitmapDescriptorFactory.fromResource(R.drawable.interestpoint_spot);
        } else if (type.equals("餐饮")) {
            bitmap = BitmapDescriptorFactory.fromResource(R.drawable.interestpoint_catering);
        } else if (type.equals("酒店")) {
            bitmap = BitmapDescriptorFactory.fromResource(R.drawable.interestpoint_hotel);
        } else if (type.equals("服务区")) {
            bitmap = BitmapDescriptorFactory.fromResource(R.drawable.interestpoint_service_area);
        } else {

...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final int UNSCALED_DEFAULT_SELECTION_DIVIDERS_DISTANCE = 36;
    ...
    class InputTextFilter extends NumberKeyListener {
        ...
        public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart, int dend) {
            if (mDisplayedValues == null) {
                ...
                String result =
                    String.valueOf(dest.subSequence(0, dstart)) + filtered + dest.subSequence(dend, dest.length());
                ...
                case View.NO_ID: {
                    switch (action) {
                        ...
                        case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                            if (NumberPicker.this.isEnabled() && (getWrapSelectorWheel()
    ...
    public void setEditTextFocusable(boolean focusable) {
        mInputText.setFocusable(focusable);
    }
}
